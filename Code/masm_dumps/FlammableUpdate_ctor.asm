...
??0FlammableUpdate@@QAE@PAVThing@@PBVModuleData@@@Z PROC
    ...
    db 00Ch,0D0h,0C9h,009h,001h,0C7h,046h,010h,0A0h,0CBh,009h,001h,083h,0C9h,0FFh,033h
    db 0C0h,089h,046h,014h,089h,04Eh,018h,089h,04Eh,01Ch,0C7h,046h,020h,07Ch,025h,00Ah
    db 001h,08Bh,056h,008h,06Ah,001h,052h,08Bh,0CEh,089h,044h,024h,018h,0C7h,006h,084h
    db 006h,00Ch,001h,0C7h,046h,00Ch,0C0h,005h,00Ch,001h,0C7h,046h,010h,0B4h,005h,00Ch

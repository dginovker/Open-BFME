...
; Retail @ 0x005DCD90 size 31
_TEXT SEGMENT
public _bfme_export_f3abeb31
_bfme_export_f3abeb31 PROC
    db 56h,6Ah,18h,8Bh,0F1h,0E8h,96h,51h
    db 2Ah,00h,83h,0C4h,04h,85h,0C0h,74h
    db 0Ah,56h,8Bh,0C8h,0E8h,2Ah,40h,0A4h
    db 0FFh,5Eh,0C3h,33h,0C0h,5Eh,0C3h
_bfme_export_f3abeb31 ENDP
_TEXT ENDS
END

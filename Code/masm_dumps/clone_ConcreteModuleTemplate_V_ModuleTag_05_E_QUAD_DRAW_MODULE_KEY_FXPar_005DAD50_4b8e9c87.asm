...
; Retail @ 0x005DAD50 size 31
_TEXT SEGMENT
public _bfme_export_4b8e9c87
_bfme_export_4b8e9c87 PROC
    db 56h,6Ah,0Ch,8Bh,0F1h,0E8h,0D6h,71h
    db 2Ah,00h,83h,0C4h,04h,85h,0C0h,74h
    db 0Ah,56h,8Bh,0C8h,0E8h,24h,74h,0A4h
    db 0FFh,5Eh,0C3h,33h,0C0h,5Eh,0C3h
_bfme_export_4b8e9c87 ENDP
_TEXT ENDS
END

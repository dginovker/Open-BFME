...
; Retail @ 0x005DF250 size 94
_TEXT SEGMENT
public _bfme_export_b17a6d85
_bfme_export_b17a6d85 PROC
    db 6Ah,0FFh,68h,7Bh,0B0h,03h,01h,64h
    db 0A1h,00h,00h,00h,00h,50h,64h,89h
    db 25h,00h,00h,00h,00h,51h,56h,6Ah
    db 0Ch,0E8h,0C2h,2Ch,2Ah,00h,8Bh,0F0h
    db 83h,0C4h,04h,89h,74h,24h,04h,33h
    db 0C0h,3Bh,0F0h,89h,44h,24h,10h,74h
    db 1Dh,8Bh,0CEh,0E8h,0F0h,0DFh,0A3h,0FFh
    db 0C7h,06h,64h,0Eh,11h,01h,0C7h,46h
    db 04h,60h,0Eh,11h,01h,0C7h,46h,08h
    db 4Ch,0Eh,11h,01h,8Bh,0C6h,8Bh,4Ch
    db 24h,08h,5Eh,64h,89h,0Dh,00h,00h
    db 00h,00h,83h,0C4h,10h,0C3h
_bfme_export_b17a6d85 ENDP
_TEXT ENDS
END

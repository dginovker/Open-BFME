...
// ----------------------------------------------------------------------------
/* BFME shadow-shim: retail switched every module pool from create-on-demand to
   lookup of a centrally pre-created pool - lotrbfme.exe's getClassMemoryPool
   bodies call MemoryPoolFactory::findMemoryPool(name) (1 arg), not
   createMemoryPool(name, size, -1, -1) (proven by disasm @0x1EEB00 vs our obj). */

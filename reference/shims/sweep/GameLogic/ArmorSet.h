...
// ArmorSet.h -- BFME shadow shim.
// Verbatim copy of the ZH GeneralsMD header except for the ArmorSetType enum:
// BFME retail's ArmorSetFlags bit-name list (lotrbfme.exe string cluster
// "VETERAN","ELITE","HERO","PLAYER_UPGRADE","WEAK_VERSUS_BASEDEFENSES",
// "ALTERNATE_FORMATION","MOUNTED","PLAYER_UPGRADE_2","PLAYER_UPGRADE_3",
// "UNBESIEGEABLE","AS_TOWER" + pointer array near file offset 0xEA68F4) shows
// 11 flags; ZH had 8. Confirmed by code: retail SparseMatchFinder<
// ArmorTemplateSet,ArmorSetFlags>::findBestInfoSlow masks the bitset tail word
// with 0x7FF (11 bits) where ZH emits 0xFF (8 bits).
...
enum ArmorSetType
{
	...
	ARMORSET_ALTERNATE_FORMATION = 5,
	ARMORSET_MOUNTED,
